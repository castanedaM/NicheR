...
occ_geo_basic_pts <- terra::extract(pred_2d[[c("bio_1", "bio_12")]],
                                    occ_geo_basic[ , c("x", "y")])
...
add_data(occ_geo_basic_pts, x = "bio_1", y = "bio_12", pts_col = "orange", pch = 20)
add_data(as.data.frame(t(ref_ellipse$centroid)), x = "bio_1", y = "bio_12", pts_col = "red", pch = 15, cex = 1.5)
```
...
occ_cent_pts <- terra::extract(pred_2d[[c("bio_1", "bio_12")]],
                               occ_cent[ , c("x", "y")])
occ_edge_pts <- terra::extract(pred_2d[[c("bio_1", "bio_12")]],
                               occ_edge[ , c("x", "y")])
occ_rand_pts <- terra::extract(pred_2d[[c("bio_1", "bio_12")]],
                               occ_rand[ , c("x", "y")])
...
add_data(occ_cent_pts, x = "bio_1", y = "bio_12", pts_col = "orange", pch = 20)
...
add_data(occ_edge_pts, x = "bio_1", y = "bio_12", pts_col = "orange", pch = 20)
...
add_data(occ_rand_pts, x = "bio_1", y = "bio_12", pts_col = "orange", pch = 20)
```
...
```{r}
occ_suit <- sample_data(100, pred_2d, "suitability", method = "suitability", seed = 123)
occ_maha <- sample_data(100, pred_2d, "Mahalanobis", method = "mahalanobis", seed = 123)

occ_suit_pts <- terra::extract(pred_2d[[c("bio_1", "bio_12")]],
                               occ_suit[ , c("x", "y")])
occ_maha_pts <- terra::extract(pred_2d[[c("bio_1", "bio_12")]],
                               occ_maha[ , c("x", "y")])
...
# Suitability
terra::plot(pred_2d[["suitability"]], main = "G-Space: Method = Suitability"); points(occ_suit[, 1:2], pch = 20, col = "red")
...
add_data(occ_suit_pts, x = "bio_1", y = "bio_12", pts_col = "orange", pch = 20)

# Mahalanobis
terra::plot(pred_2d[["Mahalanobis"]], main = "G-Space: Method = Mahalanobis"); points(occ_maha[, 1:2], pch = 20, col = "red")
...
add_data(occ_maha_pts, x = "bio_1", y = "bio_12", pts_col = "orange", pch = 20)
```
...
```{r}
occ_strict_F <- sample_data(100, pred_2d, "suitability", strict = FALSE, seed = 123)
occ_strict_T <- sample_data(100, pred_2d, "suitability_trunc", strict = TRUE, seed = 123)

occ_strict_F_pts <- terra::extract(pred_2d[[c("bio_1", "bio_12")]],
                               occ_strict_F[ , c("x", "y")])
occ_strict_T_pts <- terra::extract(pred_2d[[c("bio_1", "bio_12")]],
                               occ_strict_T[ , c("x", "y")])
...
# Lax
terra::plot(pred_2d[["suitability"]], main = "G-Space: Strict = FALSE"); points(occ_strict_F[, 1:2], pch = 20, col = "red")
...
add_data(occ_strict_F_pts, x = "bio_1", y = "bio_12", pts_col = "orange", pch = 20)

# Strict
terra::plot(pred_2d[["suitability_trunc"]], main = "G-Space: Strict = TRUE"); points(occ_strict_T[, 1:2], pch = 20, col = "red")
...
add_data(occ_strict_T_pts, x = "bio_1", y = "bio_12", pts_col = "orange", pch = 20)
```
...
occ_geo_3d_pts <- terra::extract(pred_3d[[c("bio_1", "bio_12", "bio_15")]],
                               occ_geo_3d[ , c("x", "y")])
...
add_data(occ_geo_3d_pts, x = "bio_1", y = "bio_12", pts_col = "orange", pch = 20)
...
add_data(occ_geo_3d_pts, x = "bio_1", y = "bio_15", pts_col = "orange", pch = 20)
```
...
occ_bias_xy_pts <- terra::extract(pred_3d[[c("bio_1", "bio_12", "bio_15")]],
                               occ_bias_xy[ , c("x", "y")])
...
add_data(occ_bias_xy_pts, x = "bio_1", y = "bio_12", pts_col = "orange", pch = 20)
add_data(as.data.frame(t(ref_ellipse$centroid)), x = "bio_1", y = "bio_12", pts_col = "red", pch = 15, cex = 1.5)
```
